...
public final class Util {
	...
	public static final String SONAR_API_KEY = "7685fe10859d2e47df6706504d604e40";
    ...
    public static final String SUBSONIC_REST_PROTOCOL_VERSION = "1.2.0";
    public static final String SUBSONIC_REST_CLIENT_ID = "SonarTrials";

    // TODO Remove hard-coded values
	public static final String SUBSONIC_SERVER_URL = "http://192.168.7.2:4040";
	public static final String SUBSONIC_USERNAME = "churlbong";
	public static final String SUBSONIC_PASSWORD = "dlanod";
...
//    private static final Map<Integer, Version> SERVER_REST_VERSIONS = new ConcurrentHashMap<Integer, Version>();
	private static Version SERVER_REST_VERSION;
...
//    }
    ...
    public static void setServerRestVersion(Version version) {
        SERVER_REST_VERSION = version;//SERVER_REST_VERSIONS.put(getActiveServer(context), version);
    }

    public static Version getServerRestVersion() {
        return SERVER_REST_VERSION;//return SERVER_REST_VERSIONS.get(getActiveServer(context));
    }
...
//    }
    ...
    public static String getRestUrl(String method) {
        StringBuilder builder = new StringBuilder();

//        SharedPreferences prefs = getPreferences(context);

//        int instance = prefs.getInt(Constants.PREFERENCES_KEY_SERVER_INSTANCE, 1);
        String serverUrl = SUBSONIC_SERVER_URL;//prefs.getString(Constants.PREFERENCES_KEY_SERVER_URL + instance, null);
        String username = SUBSONIC_USERNAME;//prefs.getString(Constants.PREFERENCES_KEY_USERNAME + instance, null);
        String password = SUBSONIC_PASSWORD;//prefs.getString(Constants.PREFERENCES_KEY_PASSWORD + instance, null);
        ...
        builder.append("&v=").append(SUBSONIC_REST_PROTOCOL_VERSION);
        builder.append("&c=").append(SUBSONIC_REST_CLIENT_ID);
